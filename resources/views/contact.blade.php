<x-layout>
  <main class="overflow-hidden">
      ...
      <div class="bg-warm-gray-50">
        <div class="py-24 lg:py-32">
          <div class="relative z-10 max-w-7xl mx-auto pl-4 pr-8 sm:px-6 lg:px-8">
            <h1 class="text-4xl font-extrabold tracking-tight text-blue-600      sm:text-5xl lg:text-6xl">Get in touch</h1>
      ...
      <section class="relative bg-white" aria-labelledby="contact-heading">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-blue-700">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="relative bg-white shadow-xl">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3">
              <!-- Contact information -->
              <div class="relative overflow-hidden py-10 px-6 bg-blue-500 from-teal-500 to-teal-600 sm:px-10 xl:p-12">
                ...
                @foreach($contacts as $contact)
                    ...
                    <h3 class="text-lg font-medium text-white">{{ $contact->title }}</h3>
                    <p class="mt-6 text-base text-teal-50 max-w-3xl">{{ $contact->description }}</p>
                    <dl class="mt-8 space-y-6">
                      ...
                      <dd class="flex text-base text-teal-50">
                        ...
                        <span class="ml-3">{{ $contact->contact_number }}</span>
                      </dd>
              ...
              <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12 bg-blue-200">
                ...
                <form action="#" method="POST" class="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                  ...
                  <div>
                    ...
                    <div class="mt-1">
                      <input type="text" name="phone" id="phone" autocomplete="tel" class="py-3 px-4 block w-full shadow-sm text-warm-gray-900 focus:ring-blue-600 focus:border-blue-600 border-warm-gray-300 rounded-md" aria-describedby="phone-optional">
                    </div>
                  </div>
                  <div class="sm:col-span-2">
                    <label for="subject" class="block text-sm font-medium text-warm-gray-900">Subject</label>
                    <div class="mt-1">
                      <input type="text" name="subject" id="subject" class="py-3 px-4 block w-full shadow-sm text-warm-gray-900 focus:ring-blue-600 focus:border-blue-600 border-warm-gray-300 rounded-md">
                    </div>
                  </div>
                  <div class="sm:col-span-2">
                    <div class="flex justify-between">
      ...
      <section aria-labelledby="offices-heading">
        <div class="max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
          <h2 id="offices-heading" class="text-3xl font-extrabold text-blue-600">Our Branches</h2>
          ...
          <div class="mt-10 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
            <div>
              <h3 class="text-lg font-medium text-warm-gray-900">Thoyandou</h3>
              <p class="mt-2 text-base text-warm-gray-500">
                <span class="block">4556 Brendan Ferry</span>

                <span class="block">Thoyandou, CA 90210</span>
              </p>
            </div>

            <div>
              <h3 class="text-lg font-medium text-warm-gray-900">Polokwane</h3>
              <p class="mt-2 text-base text-warm-gray-500">
                <span class="block">886 Grobler Streets</span>

                <span class="block">Polokwane, NY 12345</span>
              </p>
            </div>

            <div>
              <h3 class="text-lg font-medium text-warm-gray-900">Pretoria</h3>
              <p class="mt-2 text-base text-warm-gray-500">
                <span class="block">7363 Troy Pass</span>

                <span class="block">Pretoria, ON N3Y 4H8</span>
              </p>
            </div>

            <div>
              <h3 class="text-lg font-medium text-warm-gray-900">Cape Town</h3>
              <p class="mt-2 text-base text-warm-gray-500">
                <span class="block">114 Rissik Lane</span>

                <span class="block">Cape Town N1 2EF</span>
              </p>
            </div>
          </div>
        </div>
